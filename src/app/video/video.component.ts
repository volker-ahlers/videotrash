...
export class VideoComponent {
  ...
  constructor() {
    ...
    */
    effect(() => {
      ...
      console.warn("effect", this.constructor.name, this.view, this.sensor_label);

      if (this.selectedMessage()?.sensor_label !== "") {
        this.debug && console.log("this.selectedMessage()", this.selectedMessage()?.sensor_label, this.sensor_label);
  ...
  */
  setUrl(label: string) {
    ...
    if (stream !== undefined) {
      ...
      this.url = this.view === 'cockpit' ? stream.user_stream_dir_raw : stream.user_stream_dir_detection;
    }
  }
  ...
  */
  ngAfterViewInit() {
    this.debug && console.log("init video ngAfterViewInit", this.hlsvideo, this.hlsvideo.nativeElement);
  ...
  */
  playVideo() {
    console.log("this.hlsvideo.nativeElement.paused", this.hlsvideo.nativeElement.paused);
    console.log("this.hlsvideo.nativeElement.ended", this.hlsvideo.nativeElement.ended);
    if (this.hlsvideo?.nativeElement && (this.hlsvideo.nativeElement.paused || this.hlsvideo.nativeElement.ended)) {
      setTimeout(() => {
        this.sethlsSupport();
        this.currenttime = 0;
  ...
  */
  jumpToTime(time: number) {
    ...
    setTimeout(() => {
      this.debug && console.log("label", this.selectedMessage()?.sensor_label, this.sensor_label);
  ...
  */
  ...
  ngOnDestroy() {
    this.debug && console.warn("destroyed", this.constructor.name, this.view, this.sensor_label);
  }
}
